...
<template>
  ...
  >
    <h3 class="mb-4 text-center font-yu-gothic text-xl font-bold text-vue-blue md:mb-10 md:text-3xl">{{ supportLevelTitle }}</h3>
    <div
      class="flex flex-wrap justify-center gap-[5.33vw] px-5 md:gap-[4%] lg:gap-[3%]"
    >
      <SponsorLogo
