...
<template>
  <div>
    ...
    <div class="px-5 mx-auto max-w-[43.75rem] text-sm leading-7 text-vue-blue lg:max-w-[73.75rem] lg:text-lg lg:leading-8">
      ...
      <p class="mb-16">これらの差別、ハラスメント行為は会話、セッション、スポンサーブース、パーティ、SNS など、Vue Fes Japan に関連するあらゆる場面、場所に不適切です。意図して行ったかどうかに関わらず、Vue.js 日本ユーザーグループの判断でこれらの行為を止めるように求められた場合、すみやかに従わなければなりません。指示に従わない場合、Vue Fes Japan 内での行動を制限、または参加費の払い戻しなく退席をしていただく場合があります。</p>
